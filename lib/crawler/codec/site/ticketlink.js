...
class Ticketlink extends Codec {
  ...
  async decodeEvents() {
    ...
    const eventSection = $('#container ul.event_top_list li');
    ...
    eventSection.each(function(i, elem) {
      events.push({event_uri: that.origin + $(this).find("a").attr("href")})
    });
